...
axes[0].plot(ts, setting_flow_rate, color='C0')
axes[0].set_xlabel("Time")
axes[0].set_ylabel("Amplitude")

axes[1].set_title("Magnitude Spectrum")
axes[1].magnitude_spectrum(setting_flow_rate, Fs=1, color='C1')

axes[2].set_title("Phase Spectrum")
axes[2].phase_spectrum(setting_flow_rate, Fs=1, color='C2')

fig.tight_layout()
plt.savefig('./img/in_freq.png')
plt.show()